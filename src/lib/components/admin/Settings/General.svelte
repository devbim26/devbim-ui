						...
						<div class="flex w-full justify-between items-center">
							<div class="flex flex-col text-xs text-gray-700 dark:text-gray-200">
								<div class="flex gap-1">
									...
									{#if $config?.features?.enable_version_update_check}
										<a
											href="https://github.com/DevBIM/DevBIM/releases/tag/v{version.latest}"
											target="_blank"
										>
											{updateAvailable === null
						...
						<div class="mt-1">
							<div class="flex space-x-1">
								<a href="https://discord.gg/5rJgQTnV4s" target="_blank">
									<img
										alt="Discord"
										src="https://img.shields.io/badge/Discord-DevBIM-blue?logo=discord&logoColor=white"
									/>
								</a>

								<a href="https://twitter.com/DevBIM" target="_blank">
									<img
										alt="X (formerly Twitter) Follow"
										src="https://img.shields.io/twitter/follow/DevBIM"
									/>
								</a>

								<a href="https://github.com/DevBIM/DevBIM" target="_blank">
									<img
										alt="Github Repo"
										src="https://img.shields.io/github/stars/DevBIM/DevBIM?style=social&label=Star us on Github"
									/>
								</a>
							</div>
						</div>
						...
						<div class="flex w-full justify-between items-center">
							<div class="text-xs pr-2">
								...
								{#if $config?.license_metadata}
									<a
										href="https://devbim.com/docs/enterprise"
										target="_blank"
						...
						{#if adminConfig?.ENABLE_API_KEY_ENDPOINT_RESTRICTIONS}
							<div class=" flex w-full flex-col pr-2">
								...
								<div class="mt-2 text-xs text-gray-400 dark:text-gray-500">
									<!-- https://devbim.com/docs/getting-started/advanced-topics/api-endpoints -->
									<a
										href="https://devbim.com/docs/getting-started/api-endpoints"
										target="_blank"
